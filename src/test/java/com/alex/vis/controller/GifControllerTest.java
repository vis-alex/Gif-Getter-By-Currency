package com.alex.vis.controller;

import com.alex.vis.service.service_impl.GiphyGifServiceImpl;
import com.alex.vis.service.service_impl.OpenExchangeRatesServiceImpl;
...
public class GifControllerTest {
    ...
    public void whenReturnListOfCharCodes() throws Exception {
        ...
        mockMvc.perform(get("/alex/vis/getcodes")
    ...
    public void whenReturnRichGif() throws Exception {
        ...
        mockMvc.perform(get("/alex/vis/getgif/TESTCODE")
                .contentType(MediaType.APPLICATION_JSON))
                .andDo(print())
